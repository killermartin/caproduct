...
<body> 
           ...
           <div class="col-md-6 col-xl-6 col-xs-12 mt-3">
               <div class="container-fluid">
                <form>
                    ...
                    <div>
                        <p class="psw pb-1">
                          <a href="forget-password.php" class="text-decoration-none text-danger">I forgot my password</a>
                        </p> 
                    </div>
                    <div class="queary" >
                        <p class="psw" style="font-weight: bold;">New User?<a href="register.php" class="text-decoration-none text-success" > Register Now</a></p>
                    </div>
                </form>
              </div>
           </div>
   ...
   <div class="bg-white p-4 d-block d-md-none d-xl-none d-lg-block">
    <form>
      ...
      <div>
          <p class="psw pb-1">
            <a href="forget-password.html" class="text-decoration-none text-danger">I forgot my password</a>
          </p> 
      </div>
      <div class="queary" >
